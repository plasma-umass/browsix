...
export syscallTbl = [
	...
	sys_ni_syscall, \\ 49 bind
	sys_ni_syscall, \\ 50 listen
	sys_ni_syscall, \\ 51 getsockname
	sys_ni_syscall, \\ 52 getpeername
	sys_ni_syscall, \\ 53 socketpair
	sys_ni_syscall, \\ 54 setsockopt
