...
function integrateWasmJS(Module) {
    ...
    var wasmTextFile = Module['wasmTextFile'] || "hello.wasm2.wast";
    var wasmBinaryFile = Module['wasmBinaryFile'] || "hello.wasm2.wasm";
    var asmjsCodeFile = Module['asmjsCodeFile'] || "hello.wasm2.asm.js";
    ...
    function getBinary() {
        var binary;
	if (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER || ENVIRONMENT_IS_BROWSIX) {
    ...
    function doNativeWasm(global, env, providedBuffer) {
        ...
        info['env'] = env;
        var instance;
	//providedBuffer = new ArrayBuffer(64*1024*1024);
        instance = Wasm['instantiateModule'](getBinary(), info, providedBuffer);
        exports = instance.exports;

	// no need to merge, we passed in our SharedArrayBuffer
...
STATICTOP = STATIC_BASE + 8800;
/* global initializers */  __ATINIT__.push();


var STATIC_BUMP = 8800;
...
var _environ=STATICTOP; STATICTOP += 16;;var ___environ=_environ;function ___buildEnvironment(env) {
    ...
    args = args.slice(1); //[args[0], args[0]].concat(args.slice(2));
